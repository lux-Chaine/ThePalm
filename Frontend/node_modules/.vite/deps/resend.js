...
var Emails = class {
  ...
  async share(id, payload) {
    return await this.resend.post(`/emails/${id}/share`, { expires_in: payload == null ? void 0 : payload.expiresIn });
  }
...
function buildMetricsQuery(options) {
  ...
  const params = {
    ...
    metrics: (_a = options.metrics) == null ? void 0 : _a.join(","),
    dimensions: (_b = options.dimensions) == null ? void 0 : _b.join(","),
    domain_id: (_c = options.domainId) == null ? void 0 : _c.join(","),
    email_id: (_d = options.emailId) == null ? void 0 : _d.join(","),
    broadcast_id: (_e = options.broadcastId) == null ? void 0 : _e.join(",")
  };
  const searchParams = new URLSearchParams();
...
var Resend = class {
  constructor(key, options) {
    ...
    this.baseUrl = (options == null ? void 0 : options.baseUrl) ?? getDefaultBaseUrl();
    this.userAgent = (options == null ? void 0 : options.userAgent) ?? getDefaultUserAgent();
